    ...
    <div className="flex h-full flex-col items-center justify-center gap-5 px-6 text-center">
      ...
      <div>
        ...
        <p className="mt-1 max-w-md text-sm text-muted-foreground">
          为高维链接而生的记录工作台。建立你的梦角 / OC 档案，记录状态强弱与占卜灵光，
          让时间替你看见脉络。
        </p>
      </div>
...
function EntityView({ entity, onEdit }: { entity: Entity; onEdit: () => void }) {
  ...
  return (
    <div className="mx-auto flex min-h-full max-w-4xl flex-col gap-5 px-4 py-6 sm:px-6 sm:py-8">
      {/* 主体头部 */}
      <header className="glass flex flex-col gap-4 rounded-2xl p-5">
        <div className="flex items-start justify-between gap-4">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <span className="text-xs text-muted-foreground">{entity.category || '未分类'}</span>
            </div>
          </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button variant="secondary" onClick={() => setDivOpen(true)}>
