...
// 三项结果：空间感 / 存在感 / 情绪状态。完全随机，无稀有度，不写入任何记录。
...
const SPACE_VISUAL: Record<string, SpaceVisual> = {
  ...
  不在这里: { distance: 0.95, density: 2, jitter: 0.3 },
...
const EMOTION_VISUAL: Record<string, EmotionVisual> = {
  ...
  温和: { intensity: 0.4, turbulence: 0.12 },
  紧绷: { intensity: 0.78, turbulence: 0.45 },
  翻涌: { intensity: 0.88, turbulence: 0.95 },
  忧郁: { intensity: 0.45, turbulence: 0.25 },
  苦恼: { intensity: 0.58, turbulence: 0.5 },
  犹豫: { intensity: 0.5, turbulence: 0.7 },
  激动: { intensity: 0.92, turbulence: 0.8 },
}
